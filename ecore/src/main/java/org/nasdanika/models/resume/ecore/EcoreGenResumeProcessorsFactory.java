package org.nasdanika.models.resume.ecore;
...
@EPackageNodeProcessorFactory(nsURI = ResumePackage.eNS_URI)
public class EcoreGenResumeProcessorsFactory {
...
//	public final AccessLevelProcessorsFactory accessLevelFactory;
	...
	public EcoreGenResumeProcessorsFactory(Context context) {
...
//						}),
					...
					Files.writeString(new File("target/resume.drawio").toPath(), document.save(null));
				} catch (Exception e) {
					e.printStackTrace();
